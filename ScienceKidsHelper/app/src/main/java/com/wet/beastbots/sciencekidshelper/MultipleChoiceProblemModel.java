...
public class MultipleChoiceProblemModel extends ProblemModel {
    ...
    MultipleChoiceProblemModel(String[] listOfOptions, int problemImage, int correctAnswer, String problemText)
    {
